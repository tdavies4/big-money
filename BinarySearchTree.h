...
template<class ItemType>
BinarySearchTree<ItemType>::BinarySearchTree(int s)
{
	queueArray = new ItemType[s];
	queueSize = s;
	front = -1;
	rear = -1;
	numItems = 0;
...
template<class ItemType>
BinarySearchTree<ItemType>::BinarySearchTree(const BinarySearchTree &obj)
{
	queueArray = new ItemType[obj.queueSize];
...
template<class ItemType>
void BinarySearchTree<ItemType>::enqueue(ItemType num)
{
	if (isFull())
...
template<class ItemType>
void BinarySearchTree<ItemType>::dequeue(ItemType &num)
{
	if (isEmpty())
